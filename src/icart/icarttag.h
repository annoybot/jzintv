...
typedef struct ict_credbit_t
{
    union
    {
        ...
        {
            BFE(uint_8 author               : 1,
            BFE(uint_8 game_art             : 1,
            BFE(uint_8 music                : 1,
            BFE(uint_8 sound_effects        : 1,
            BFE(uint_8 voices               : 1,
            BFE(uint_8 documentation        : 1,
            BFE(uint_8 game_concept         : 1,
                uint_8 box_art              : 1)))))));
        } s;
    } u;
} ict_credbit_t;
...
typedef struct ict_compat_t
{
    union
    {
        ...
        {
            /* Byte 0 */
            BFE(uint_8 keyboard_component   : 2,
            BFE(uint_8 intellivoice         : 2,
            BFE(uint_8 rsvd_0_4             : 2,        /* Was 4CTRL    */
                uint_8 ecs                  : 2)));
                                           
            /* Byte 1 */                   
            BFE(uint_8 intellivision_2      : 2,
            BFE(uint_8 tutorvision          : 2,
            BFE(uint_8 rsvd_1_4             : 2,
                uint_8 rsvd_1_6             : 2)));
            ...
            /* Byte 3 */
            BFE(uint_8 jlp_flash_hi         : 2,
            BFE(uint_8 rsvd_3_2             : 3,
            BFE(uint_8 lto_mapper           : 1,
                uint_8 jlp_accel            : 2)));
...
{
    uint_16     addr_lo;        /* starting address                         */
    uint_16     addr_hi;        /* ending address (inclusive range)         */
    uint_8      flags;          /* flags associated with span               */
} ict_memattr_t;
