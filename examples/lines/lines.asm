...
;;  Lines Demo                                                              ;;
;;                                                                          ;;
;;  This demo draws 8 non-parallel lines that go from the top of the screen ;;
...
;; ======================================================================== ;;
        ...
        CFGVAR  "name" = "SDK1600 - Bitmapped Lines Demo (2010) (JZ)"
        CFGVAR  "short_name" = "Lines Demo"
        CFGVAR  "year" = 2010
...
PLOT    PROC
        ...
        ANDI        #$FFF8,     R1      ; Clamp Y to card row => Row * 8
        SLL         R1,         1       ; Row * 16
        ADDR        R1,         R0      ;
        SLR         R1,         2       ; Row * 4
        ADDR        R0,         R1
