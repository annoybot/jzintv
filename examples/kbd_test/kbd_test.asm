;* ======================================================================== *;
;*  The routines and data in this file (kbd_test.asm) are dedicated to the  *;
...
;; ======================================================================== ;;
 ...
 CFGVAR "name" = "SDK-1600 ECS Alphanumeric Keyboard Scanning Test"
 CFGVAR "short_name" = "ECS Alpha Kbd Test"
 CFGVAR "author" = "Joe Zbiciak"
 CFGVAR "year" = 2010
 CFGVAR "license" = "CC CC0 v1.0"
 CFGVAR "desc" = "Demonstrates ECS alphanumeric keyboard scanning routines."
