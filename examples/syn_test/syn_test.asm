;* ======================================================================== *;
;*  The routines and data in this file (syn_test.asm) are dedicated to the  *;
...
;;==========================================================================;;
 CFGVAR  "name" = "SDK-1600 ECS Synthesizer Keyboard Scanning Test Program"
 CFGVAR  "short_name" = "ECS Synth Test"
 CFGVAR  "author" = "Joe Zbiciak"
 CFGVAR  "year" = 2010
 CFGVAR  "license" = "CC CC0 v1.0"
 CFGVAR  "desc" = "Demonstrates ECS synthesizer keyboard scanning routines."
